             ...
             // $id=$id+1;
              ...
              ?>
                        <tr>
						  ...
						  <td><?php echo $row['financecomment']; ?></td>
						  <td style="text-align:center; margin-top:10px; width:250px;"> 
								<form method="post" action="clearfinance.php"> 
				...
				<div class="box-footer clearfix">
						<div class="form-group" style="text-align:right; margin-top:-55px;"><a href="Finance.php" class="btn btn-primary" name="exit" type="exit"
								id="exit">Exit</a> 
						</div>
                </div>
