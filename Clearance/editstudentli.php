...
if(isset($_POST['update'])) { 
    ...
    $sql = "INSERT INTO bookstudentli (regno, name, status, comment) 
					  VALUES('$regno','$name','$status', '$comment')";
	
	if(mysqli_query($conn,$sql)){?>
	
		<script>alert("Student Cleared successfully");window.location='Library.php'</script>
		<?php
			 ...
			 <div class="form-group">
          	...
          	<div class="modal-footer form-group">
						<div class="row">
							...
							<div class="form-group" style="margin-top:-5px;"><a href="Library.php" class="btn btn-primary" name="Cancel" type="Cancel"
								id="Cancel">Cancel</a> 
							</div> 
						</div>
					</div>
