                ...
                <div class="box-body"> 
                    <table id="example1" class="table table-bordered table-hover" >
                      <thead>
                        ...
                        <tr>
                          <?php
              $result= mysqli_query($conn,"SELECT * FROM `bookstudentspo` order by id DESC") or die (mysqli_error($conn));
              $i=0;
              ...
              ?>
				...
				<div class="box-footer clearfix">  
					<div class="row">
						...
						<div class="form-group"><a href="Sports.php" class="btn btn-primary pull-right" name="exit" type="exit"
								id="exit">Exit</a> 
						</div>  
					</div> 
                </div>
