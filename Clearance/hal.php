		 ...
		 <section class="content">
          <div class="row">
            <div class="col-xs-10">
              ...
              $result= mysqli_query($conn,"select * from allsub order by id ASC") or die (mysqli_error($conn));
              if( $result){
             ...
             // $id=$id+1;
              ...
              ?>
                        <tr>
						  ...
						  <td><?php echo $row['hallscomment']; ?></td>
						  <td style="text-align:center; margin-top:10px; width:250px;"> 
								<form method="post" action="clearhalls.php"> 
				...
				<div class="box-footer clearfix">
						<div class="form-group" style="text-align:right; margin-top:-55px;"><a href="Halls.php" class="btn btn-primary" name="exit" type="exit"
								id="exit">Exit</a> 
						</div>
                </div>
