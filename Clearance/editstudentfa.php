...
if(isset($_POST['update'])) { 
    ...
    $sql = "INSERT INTO bookstudentfa (regno, name, status, comment) 
					  VALUES('$regno','$name','$status', '$comment')";
	
	if(mysqli_query($conn,$sql)){?>
	
		<script>alert("Student Cleared successfully");window.location='Faculty.php'</script>
		<?php
