...
if(isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO bookstudentha (regno, name, phone, Comment) 
			...
			<div class="form-group  has-feedback <?php echo (!empty($email_err)) ? 'has-error' : ''; ?>">
          	...
          	<div class="modal-footer form-group">
				...
				<div class="row">
					...
					<div class="form-group"><a href="bookedha.php" class="btn btn-primary large pull-right" name="cancel" type="cancel"
								id="cancel">Cancel</a> 
					</div> 
                </div> 
                </div> 
