             ...
             // $id=$id+1;
              ...
              ?>
                        <tr>
						  ...
						  <td><?php echo $row['sportscomment']; ?></td>
						  <td style="text-align:center; margin-top:10px; width:250px;"> 
								<form method="post" action="clearsports.php"> 
				...
				<div class="box-footer clearfix">
						<div class="form-group" style="text-align:right; margin-top:-55px;"><a href="Sports.php" class="btn btn-primary" name="exit" type="exit"
								id="exit">Exit</a> 
						</div>
                </div>
