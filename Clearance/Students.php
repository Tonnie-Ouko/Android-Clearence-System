		...
		<section class="content">
          <div class="row">
                        ...
                        <tr>
						  ...
						  <td style="text-align:center; margin-top:20px; width:150px;"> 
								<form method="post" action="editstudent.php"> 
									...
									<input class="btn btn-default pull-left" name="edit" type="submit"
										id="edit" value="Edit" OnClick="return confirm('Are you sure you want to Edit');"> 
								</form> 
								<form method="post" action="<?php $_PHP_SELF ?>" style="margin-top:-50px;"> 
									<input name="id" value="<?php echo $row['id'];?>" hidden> 
									<input class="btn btn-danger pull-right" name="delete" type="submit"
										id="delete" value="Delete" OnClick="return confirm('Are you sure you want to Delete');"> 
								</form>
						   </td> 
			...
			<div class="box-footer clearfix">
				<div class="row">
					<div class="form-group"><a href="register student.php" class="btn btn-primary pull-left" name="Register student" type="Register student"
								id="Register student">Register student</a> 
					</div> 
					<!--<div class="form-group"><a href="edit.php" class="btn btn-primary pull-right" name="edit" type="edit"
