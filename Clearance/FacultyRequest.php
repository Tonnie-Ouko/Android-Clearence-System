...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Clearence | FacultyRequest</title>
            ...
            <div class="col-xs-4">
              ...
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Faculty Request</h3> 
                </div> 
                <div class="box-body"> 
                    <table id="example1" class="table table-bordered table-hover" >
                      <thead>
                        ...
                        <tr>
                          <?php
              $result= mysqli_query($conn,"SELECT * FROM `bookstudentfa` order by id DESC") or die (mysqli_error($conn));
              $i=0;
              ...
              ?>
				...
				<div class="box-footer clearfix">  
					<div class="row"> 
						...
						<div class="form-group"><a href="Faculty.php" class="btn btn-primary pull-right" name="exit" type="exit"
								id="exit">Exit</a> 
						</div>  
					</div> 
                </div>
