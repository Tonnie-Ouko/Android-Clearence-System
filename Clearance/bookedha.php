...
if(isset($_POST['delete'])) {
	...
	$id = $_POST['id'];
    $sql = "DELETE FROM bookstudentha WHERE id='$id'";
	//die($sql);
            ...
            <div class="col-xs-12"> 
                  ...
                  <div class="table-responsive">
                    <table id="example1" class="table table-bordered table-striped"> 
                        ...
                        <tr>
                          <?php
						  require'config.php';
              $result= mysqli_query($conn,"select * from bookstudentha order by id ASC") or die (mysqli_error($conn));
              $id=0;
              ...
              ?>
				...
				<div class="row">
					...
					<div class="form-group"><a href="Halls.php" class="btn btn-primary pull-right" name="cancel" type="cancel"
								id="cancel">Cancel</a> 
					</div>
					<div class="form-group"><a href="Book Studentha.php" class="btn btn-primary pull-left" name="book" type="book"
