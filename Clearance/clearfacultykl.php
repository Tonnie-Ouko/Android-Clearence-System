...
if (isset($_POST['update'])){
		...
		$id=$_POST['id']; 
 //INSERT INTO `allsub`(`id`, `regno`, `finance`, `financecomment`, `sports`, `sportscomment`, `faculty`, `facultycomment`, `halls`, `hallscomment`, `security`, `securitycomment`, `library`, `librarycomment`) 
 //VALUES ([value-1],[value-2],[value-3],[value-4],[value-5],[value-6],[value-7],[value-8],[value-9],[value-10],[value-11],[value-12],[value-13],[value-14])
	   ...
	   $sql="INSERT INTO allsub (faculty, facultycomment)VALUES ('$faculty','$facultycomment') WHERE id='$id'";
	  // $sql="UPDATE allsubmit SET faculty ='$faculty', facultycomment='$facultycomment' WHERE id='$id'";
		if(mysqli_query($conn,$sql)){
//die($sql);
          ?>
		<script> alert("Details updated Successfully."); window.location='Faculty.php'</script>
	<?php
          ...
          <div class="Id">
			...
			<div class="form-group  has-feedback <?php echo (!empty($regno_err)) ? 'has-error' : ''; ?>">
             ...
             <div class="form-group  has-feedback">
                <label>Comment:</label>
                <input type="text" name="facultycomment"class="form-control"  value="<?php echo $facultycomment;?>"> 
            </div>
           
			
          	<div class="modal-footer form-group">
						<div class="row">
							<input type="submit" name="update" class="btn btn-primary pull-left" value="Apply changes">
							<div class="form-group" style="margin-top:-5px;"><a href="Faculty.php" class="btn btn-primary" name="Cancel" type="Cancel"
								id="Cancel">Cancel</a> 
							</div> 
						</div>
					</div>
